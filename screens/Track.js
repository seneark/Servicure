    ...
    db.collection("TrackOrder")
      ...
      .then(async (querySnapshot) => {
        ...
        await querySnapshot.forEach(async (doc) => {
          if (
            doc.data().email != firebase.auth().currentUser.email.toString()
          ) {
            await rdb
              .ref("/location " + doc.data().phone)
              .on("value", async (snapshot) => {
                ...
                if (snapshot.val()) {
                  ...
                  // 	snapshot.val().location.latitude.toString();
                  let token =
                    "eyJhbGciOiJSUzUxMiIsImN0eSI6IkpXVCIsImlzcyI6IkhFUkUiLCJhaWQiOiJ2ZlhOSHV0NXR6WXdDWm9DejVsRiIsImlhdCI6MTY0Mjg0NDI0MywiZXhwIjoxNjQyOTMwNjQzLCJraWQiOiJqMSJ9..NcnxbjULWjSNw24ZknZxACuxxxP0nKorzhsgJLRWV15YnPYspLZ312n9o7o1Or9g1mcyJrMsawHA5w-KKwyCPuUmkKMs0ajFsj9Jxz_f7BRtJ08kR53u3SfLe1pG64cJjCwV_JH3nxlKpbaRTHgyrA8hNJZAkVtlLNh2zLJJ7m7LyBItZzQdxGx12yqeSr95ReiO448bHrgxCgnqzK7pU1do-QPQ4ni8tugYU5Z_EV91uHLa0qXEyHVaSt6W53kStCnWa0Ibzq7T7_k3UsDA-iYj2U_TEfnli9nLrNp45rxZqxu87q1eunO5LMBr3HgGl44R2zzRcPiepRdyPbi1yA";
                  const config = {
                    headers: {
                  ...
                  axios
                    ...
                    .then((data) => {
                      ...
                      let time =
                        data.data.routes[0].sections[0].summary.duration;
                      let dist_str = "";
                      let time_str = "";
                      if (dist >= 1000) {
                        dist_str =
      ...
      <Block flex>
        ...
        >
          ...
          {this.state.isLoading ? (
            <Image
              source={require("../assets/map_loader.gif")}
                ...
                {this.state.location_other.length > 0
                  ? this.state.location_other.map((item, idx) => {
                      return (
                        <Marker
                          key={idx}
                          coordinate={item.location.location}
